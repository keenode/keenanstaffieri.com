...
const about = () => (
  <div className={styles.PageContainer}>
    ...
    <article className={styles.Story}>
      ...
      <p>Dolore irure culpa sint voluptate ullamco irure. Dolor adipisicing nisi aliquip laboris anim aliqua. Aute amet consequat sint veniam incididunt reprehenderit occaecat proident fugiat laborum. Pariatur sit officia nisi proident culpa. Reprehenderit consectetur magna qui qui consectetur laborum ut.</p>
    </article>
    <h2>Skills</h2>
    <ul>
      <li>React/Redux</li>
